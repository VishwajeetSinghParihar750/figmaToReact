  ...
  return (
    <Wrapper>
      <div className="mt-4 p-10 pt-0 bg-gray-100 ">
        {/* Leaderboard Section */}
        <h2 className="text-3xl text-gray-800 mb-8">Leaderboard</h2>

        {/* Top 3 Cards */}
        <div className="flex justify-center items-center mb-10 mt-48">
          <div
          ...
          <table className="w-full text-left border-separate border-spacing-y-2 border-spacing-x-0">
            <thead>
              <tr className="bg-gray-100">
                ...
                <th className="py-2 px-4 font-semibold">Total Volume Traded</th>
              </tr>
            </thead>
            <tbody>
